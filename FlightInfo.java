...
public class FlightInfo extends JFrame {
    ...
    public FlightInfo() {
        ...
        ThemeManager.applyDarkTextFieldTheme(departureTimeField);
        ...
        ThemeManager.applyDarkTextFieldTheme(arrivalTimeField);
        ...
        ThemeManager.applyDarkTextFieldTheme(priceField);
        add(priceField, gbc);
        ...
        ThemeManager.applyDarkTextFieldTheme(totalSeatsField);
        ...
        ThemeManager.applyDarkTextFieldTheme(seatsAvailableField);
